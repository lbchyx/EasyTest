...
function(JTopo) {
    ...
    function toJson(a) {
        var b = "backgroundColor,visible,mode,rotate,alpha,scaleX,scaleY,shadow,translateX,translateY,areaSelect,paintAll".split(","),
            c = "text,elementType,x,y,width,height,visible,alpha,rotate,scaleX,scaleY,fillColor,shadow,transformAble,zIndex,dragable,selected,showSelected,font,fontColor,textPosition,textOffsetX,textOffsetY,id,type,children".split(","),
            d = "{";
...
function(a) {
    ...
    function c() {
        this.initialize = function() {
            ...
            0 != this.showSelected && (a.save(), a.beginPath(), a.strokeStyle = "rgba(199, 107, 11, 0.9)", a.fillStyle = "rgba(199, 107, 11, 0.9)", a.rect(-this.width / 2 - 3, -this.height / 2 - 3, this.width + 6, this.height + 6), a.fill(), a.stroke(), a.closePath(), a.restore())
